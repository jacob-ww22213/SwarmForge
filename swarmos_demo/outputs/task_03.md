...
## Final Output
这个 demo 应该把目标收敛为一个能跑通的系统样机：用少量专家展示路由、协作、批判和聚合四个核心机制，并通过 trace 与基线对比证明它不仅仅是一个更花哨的工作流。 这次被路由到的专家是 Planner, Product Strategist, Coding Engineer, Research Scientist，足以体现角色分工。 如果用于对外展示，要补一层更商业化的语言包装。
